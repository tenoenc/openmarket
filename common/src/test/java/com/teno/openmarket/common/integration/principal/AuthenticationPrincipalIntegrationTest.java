package com.teno.openmarket.common.integration.principal;

import com.teno.openmarket.common.integration.CommonIntegrationTest;
...
public class AuthenticationPrincipalIntegrationTest extends CommonIntegrationTest {

    @RestController
    static class TestController {
        @GetMapping("/common/test/principal")
    ...
    void should_BindLongUserId_When_ValidJwtTokenProvided() throws Exception {
        ...
        // when & then
        mockMvc.perform(get("/common/test/principal")
