package com.teno.openmarket.user.feature.auth.controller;
...
import com.teno.openmarket.user.feature.auth.mapper.UserMapper;
import com.teno.openmarket.user.feature.auth.service.SignupService;
...
@WebMvcTest
@Import({SignupController.class, TestUserSecurityConfig.class})
class SignupControllerTest extends BaseControllerTest {
    ...
    void should_ReturnResponseSuccessfully_When_RequestingSignup() throws Exception {
        ...
        given(userMapper.toCommand(any(SignupRequest.class)))
                .willReturn(command);
        ...
        verify(userMapper).toCommand(any(SignupRequest.class));
