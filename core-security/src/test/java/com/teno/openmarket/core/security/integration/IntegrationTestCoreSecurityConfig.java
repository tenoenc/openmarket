 ...
 * [코어 도메인 특화 보안 설정]
 * <p>
 * Core Security 도메인에 속한 엔드포인트의 보안 정책을 정의합니다.
 * JWT 기반 인증을 사용하므로 세션 생성 및 불필요한 기본 인증 방식을 비활성화합니다.
 */
@TestConfiguration
@EnableWebSecurity
@RequiredArgsConstructor
public class IntegrationTestCoreSecurityConfig {
    ...
    public SecurityFilterChain systemSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
            .requestMatchers("/core/security/test/principal").authenticated()
